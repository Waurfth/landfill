...
ACTIVITIES: dict[str, Activity] = {
    ...
    "gather_wood": Activity(
        name="gather_wood",
        description="Collect fallen branches and deadwood",
        trait_weights={"endurance": 0.4, "strength": 0.3, "patience": 0.3},
        base_success_chance=0.85,
        base_hours=4,
        resource_type=ResourceType.TIMBER,
        outputs={"firewood": 2.0, "timber": 0.5},
        danger_level=0.02,
        fatigue_cost=0.06,
        xp_category="woodcutting",
    ),
    "gather_stone": Activity(
        name="gather_stone",
        description="Collect loose stones from rocky ground",
        trait_weights={"strength": 0.4, "endurance": 0.4, "patience": 0.2},
        base_success_chance=0.85,
        base_hours=4,
    ...
    "build_shelter": Activity(
        ...
        required_materials={"timber": 3.0, "stone": 2.0},
    ),
    "build_well": Activity(
        name="build_well",
        description="Dig and line a well for clean water access",
        trait_weights={"strength": 0.35, "endurance": 0.3, "intelligence": 0.2, "dexterity": 0.15},
        base_success_chance=0.6,
        base_hours=8,
        required_tools=["axe", "construction"],
        outputs={},
        ...
        fatigue_cost=0.12,
        xp_category="construction",
        required_materials={"stone": 5.0},
    ),
    "build_meeting_hall": Activity(
        name="build_meeting_hall",
        description="Construct a communal gathering hall",
        trait_weights={"strength": 0.3, "intelligence": 0.25, "dexterity": 0.25, "endurance": 0.2},
        ...
        fatigue_cost=0.12,
        xp_category="construction",
        required_materials={"timber": 8.0, "stone": 4.0},
    ),
    "build_granary": Activity(
        name="build_granary",
        description="Build a secure structure for food storage",
        trait_weights={"strength": 0.3, "intelligence": 0.3, "dexterity": 0.2, "endurance": 0.2},
        base_success_chance=0.6,
        base_hours=8,
        required_tools=["axe", "construction"],
        outputs={},
        ...
        fatigue_cost=0.12,
        xp_category="construction",
        required_materials={"timber": 5.0, "stone": 3.0},
    ),
    "build_road": Activity(
        name="build_road",
...
ACTIVITY_NEED_MAPPING: dict[str, list[str]] = {
    ...
    "fishing": ["hunger"],
    "chop_wood": ["warmth", "shelter", "comfort"],
    "gather_wood": ["warmth", "shelter"],
    "gather_stone": ["shelter", "purpose"],
    "mine_stone": ["shelter"],
    "mine_ore": ["purpose"],
    "farm_plant": ["hunger"],
    "farm_tend": ["hunger"],
    ...
    "preserve_food": ["hunger", "comfort"],
    "craft_tools": ["purpose", "safety", "comfort"],
    "build_shelter": ["shelter", "safety"],
    "build_well": ["safety", "comfort", "purpose"],
    "build_meeting_hall": ["social", "comfort", "purpose"],
    "build_granary": ["safety", "purpose"],
    "build_road": ["purpose"],
    "gather_herbs": ["health"],
